...
contract Seedifyuba is Ownable {
    ...
    */
    ...
    enum State { FUNDING, IN_PROGRESS, COMPLETED }
    ...
    */
    ...
    /**
        @notice Verifies that the project is in the state funding to have
        its funds withdrawn
        @param projectId Identifier of the project to be checked
     */
    modifier canHaveFundsWithdrawn(uint256 projectId) {
        Project storage project = projects[projectId];
        require(project.state == State.FUNDING, "project not in necessary state");
        _;
    }
    ...
    */
    ...
    /**
        ...
        The project should be in funding state, otherwise it will revert
